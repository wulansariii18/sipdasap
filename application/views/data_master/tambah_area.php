...
<section class="content">
    <div class="box box-primary">
        <form role="form" action="<?php echo base_url('Area/insert'); ?>" method="post">
            <div class="box-body">
                <div class="form-group">
                    <label>Nama</label>
                    <input class="form-control" name="nama_area" type="text" value="<?php echo set_value('nama_area'); ?>">
                ...
                <div class="form-group">
                    <label>No Telp</label>
                    <input class="form-control" name="no_telp" type="text" value="<?php echo set_value('no_telp'); ?>">
                    <p class="text-red"><?php echo form_error('no_telp'); ?></p>
                </div>
                <div class="form-group">
                    <label>Tgl Mulai Kontrak</label>
                    <input class="form-control" name="tgl_mulai_kontrak" type="date" value="<?php echo set_value('tgl_mulai_kontrak'); ?>">
                    <p class="text-red"><?php echo form_error('tgl_mulai_kontrak'); ?></p>
                </div>
                <div class="form-group">
                    <label>Tgl Akhir Kontrak</label>
                    <input class="form-control" name="tgl_akhir_kontrak" type="date" value="<?php echo set_value('tgl_akhir_kontrak'); ?>">
